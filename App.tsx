  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background-dark text-white font-display">
      ...
      <footer className="mt-6 border-t border-surface-highlight p-6 text-center text-gray-600 text-[10px] md:mt-10 md:p-10 md:text-xs">
        &copy; 2025 Advertising industry get together. Gate Management System. Powered by <a href="https://www.lunorlabs.com" target="_blank" rel="noopener noreferrer" className="text-primary font-semibold hover:text-primary/80 transition-colors">lunorlabs.com</a>
      </footer>
    </div>
  );
};
